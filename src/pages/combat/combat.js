...
function combat() {
    return (
        <div className='container-left'>
            ...
            <p>Le joueur actif choisit l'ordre de résolution des combats. Chaque combat doit être résolu avant de passer au suivant. Chaque combat de résout dans l'ordre d'Initiative. Les figurines d'une unité en charge gagnent un bonus à leur Initiative pour le reste du tour, selon la distance parcourure :
                <ul>
                    <li><strong>Charger l'Arc Frontal d'un Ennemi :</strong> +1 en Initiative par pouce complet parcouru, jusqu'à un maximom de +3</li>
                    <li><strong>Charger l'Arc Latéral ou Arrière d'un Ennemi :</strong> +1 en Initiative par pouce complet parcouru, jusqu'à un maximom de +4</li>
