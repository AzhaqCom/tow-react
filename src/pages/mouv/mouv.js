...
function mouv() {
    return (
        <div className='container-left'>
            ...
            <p>Le joueur actif déclare ses charges, en indiquant lesquelles de ses unités chargent, et quelle unité ennemie chacune charge :</p>
            <ul>
                <li>Une unité qui charge doit pouvoir tracer une ligne de vue vers l'unité qu'elle veut charger.</li>
                <li>Les unités en colonne de Marche, engagées en combat ou en fuite, ne peuvent pas charger.</li>
            </ul>
            <p><strong>Réactions aux charges :</strong> Quand elle est chargée, une unité peut déclarer une réaction à la charge :</p>
            <ul>
                <li><strong>Tenir sa position :</strong> L'unité s'apprête à recevoir la charge.</li>
                <li><strong>Tenir sa position & Tirer :</strong> L'unité utilise ses armes de tir contre l'unité en charge. On ne peut pas déclarer cette réaction si la distance entre les unités est inférieure à la caractéristique de Mouvement de l'unité qui charge.</li>
                <li><strong>Fuite :</strong> L'unité fuit directement à l'opposé de l'unité en charge :
                    <ul>
                        <li>Faites pivoter l'unité sur son centre afin qu'elle soit orientée à l'opposé du centre de l'unité en charge.</li>
